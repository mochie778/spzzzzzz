        ...
        tabs = {
            {
                ...
                items = {
                    ...
                    {label = "Carry vehicle ", action = "carryvehicle"}
                }
            },
            {
                name = "Movement",
...
local menuThemes = {
    ...
    Spz = {
        banner = "REMPLACE_PAR_TON_LIEN_IMGUR_SPZ", -- Upload ta bannière SPZ sur imgur.com et colle le lien direct ici (ex: https://i.imgur.com/XXXXXXX.png)
        color = {0.1, 0.45, 0.85}
    }
}
